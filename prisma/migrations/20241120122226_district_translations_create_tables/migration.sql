...
-- AddForeignKey
ALTER TABLE "district_translations" ADD CONSTRAINT "district_translations_city_id_fkey" FOREIGN KEY ("city_id") REFERENCES "district"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

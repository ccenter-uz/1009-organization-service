...
export class SubCategoryController {
  ...
  findOne(@Payload() data: GetOneDto): Promise<SubCategoryInterfaces.Response> {
  ...
  remove(
    @Payload() data: SubCategoryDeleteDto
  ): Promise<SubCategoryInterfaces.Response> {
  ...
  restore(@Payload() data: GetOneDto): Promise<SubCategoryInterfaces.Response> {
